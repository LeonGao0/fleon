...
declare module Editor {
    ...
    module MainProcess {
        ...
        class AssetDB {
            ...
            queryPathByUrl(url: string, callfunc: (err: any, result: string) => void);
            /**
...
declare module Editor.Builder {
    ...
    export function on(
        eventName: string,
        callback: (options: BuildOptions, cb: Function) => void
    ): void;
...
declare module Editor.Scene {
     ...
     * @param cb
     */
    export function callSceneScript(
        packageName: string,
        method: string,
...
declare module Editor.JS {
     ...
     * @param args object
     */
    export function addon(obj, ...args): void;
     ...
     * @param args object
     */
    export function assign(obj, ...args): void;
     ...
     * @param except array
     */
    export function assignExcept(obj, src, except): void;
     ...
     * @param target object
     */
    export function copyprop(name, source, target): void;
     ...
     * @param base function
     */
    export function extend(cls, base): void;
     ...
     */
    export function extract(obj, propNames): any[];
     ...
     * @param path string
     */
    export function getPropertyByPath(obj, path): any;
}
